...
GAMES = [
    ...
    },
    {
        ...
        'description': 'Выживай с друзьями на острове! Собирай ресурсы, строй базу, '
                       'защищайся от монстров. Продержись 30 дней! '
                       'До 6 игроков в кооперативном режиме.',
        'short_description': 'Кооперативное выживание на острове',
        'genre': 'survival',
        'min_age': 8,
        'min_players': 1,
        'max_players': 6,
        'tags': ['выживание', 'крафт', 'мультиплеер', 'кооп', 'монстры'],
        'status': 'published',
        'is_featured': True,
